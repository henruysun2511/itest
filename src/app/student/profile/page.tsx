        ...
        <>
            <div className="relative">
                ...
                <div className="max-w-5xl mx-auto px-6">
                    <div className="relative -mt-45 flex flex-col md:flex-row items-end gap-6 pb-6 border-b">
                        ...
                        <div className="flex-1 mb-2 text-center md:text-left">
                            <Title level={2} className="!text-white !text-4xl !mb-3 drop-shadow-sm">{profile?.fullName}</Title>
                            <Text className="text-blue-400  font-bold opacity-80"><SafetyCertificateOutlined />Sinh viên</Text>
                        </div>
