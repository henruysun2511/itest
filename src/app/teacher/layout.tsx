                ...
                <Header className="bg-[var(--color-navy-deep)] h-20 flex items-center justify-between px-8 sticky top-0 z-[100] border-b border-white/10">
                    <div className="flex items-center gap-12">
                        ...
                        <Menu
                            ...
                            items={[
                                { key: 'exam-management', icon: <SolutionOutlined />, label: 'Quản lý thi' },
                                { key: 'bank', icon: <DatabaseOutlined />, label: 'Ngân hàng đề' },
                                { key: 'grading', icon: <FormOutlined />, label: 'Chấm tự luận' },
                            ]}
                        />
                    </div>
